...
@router.post("/{watchlist_id}/movies/", response_model=List[MovieResponse])   #Responsemodel güncellenmeli
...
@router.delete("/{watchlist_id}/movies/{movie_id}/", response_model=List[MovieResponse])   #Responsemodel güncellenmeli
